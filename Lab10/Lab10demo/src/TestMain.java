public class TestMain {
	...
	// Create 4 objects of Employee by passing parameters (Hint: Parameterized Constructor)
		Employee emp1 = new Employee("11AA","John",2,560000,10,20000);
		Employee emp2 = new Employee("22AA","Alice",3,570000,20,20000);
		Employee emp3 = new Employee("33AA","David",4,580000,5,20000);
		Employee emp4 = new Employee("44AA","Jane",0,590000,10,20000);
